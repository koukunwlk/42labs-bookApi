...
SRCS		=	$(PATH_APP)server.c $(PATH_APP)routes.c  $(PATH_LIBS)mongoose.c $(PATH_LIBS)mjson.c $(PATH_CONTROLLERS)book_controller.c $(PATH_MODELS)book.c $(PATH_CONTROLLERS)category_controller.c $(PATH_MODELS)category.c $(PATH_UTILS)get_id.c $(PATH_UTILS)send_json_error.c $(PATH_UTILS)has_query.c
